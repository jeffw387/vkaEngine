...
static std::map<uint32_t, std::string> CompositeAlphaFlags{
    ...
    {0x00000002, "VK_COMPOSITE_ALPHA_PRE_MULTIPLIED_BIT_KHR"},
    {0x00000004, "VK_COMPOSITE_ALPHA_POST_MULTIPLIED_BIT_KHR"},
...
static std::map<uint32_t, std::string> TransformFlags{
    ...
    {0x00000010, "VK_SURFACE_TRANSFORM_HORIZONTAL_MIRROR_BIT_KHR"},
    {0x00000020, "VK_SURFACE_TRANSFORM_HORIZONTAL_MIRROR_ROTATE_90_BIT_KHR"},
    {0x00000040, "VK_SURFACE_TRANSFORM_HORIZONTAL_MIRROR_ROTATE_180_BIT_KHR"},
    {0x00000080, "VK_SURFACE_TRANSFORM_HORIZONTAL_MIRROR_ROTATE_270_BIT_KHR"},
