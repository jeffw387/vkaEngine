...
namespace vka {
static std::map<uint32_t, std::string> Results{
    {0, "VK_SUCCESS"},
    {1, "VK_NOT_READY"},
    {2, "VK_TIMEOUT"},
    {3, "VK_EVENT_SET"},
...
static std::map<uint32_t, std::string> Formats{
    ...
    {1000156012,
     "VK_FORMAT_G10X6_B10X6_R10X6_3PLANE_420_UNORM_"
     "3PACK16"},
    {1000156013,
     "VK_FORMAT_G10X6_B10X6R10X6_2PLANE_420_UNORM_3PACK16"},
    {1000156014,
     "VK_FORMAT_G10X6_B10X6_R10X6_3PLANE_422_UNORM_"
     "3PACK16"},
    {1000156015,
     "VK_FORMAT_G10X6_B10X6R10X6_2PLANE_422_UNORM_3PACK16"},
    {1000156016,
     "VK_FORMAT_G10X6_B10X6_R10X6_3PLANE_444_UNORM_"
     "3PACK16"},
    ...
    {1000156022,
     "VK_FORMAT_G12X4_B12X4_R12X4_3PLANE_420_UNORM_"
     "3PACK16"},
    {1000156023,
     "VK_FORMAT_G12X4_B12X4R12X4_2PLANE_420_UNORM_3PACK16"},
    {1000156024,
     "VK_FORMAT_G12X4_B12X4_R12X4_3PLANE_422_UNORM_"
     "3PACK16"},
    {1000156025,
     "VK_FORMAT_G12X4_B12X4R12X4_2PLANE_422_UNORM_3PACK16"},
    {1000156026,
     "VK_FORMAT_G12X4_B12X4_R12X4_3PLANE_444_UNORM_"
     "3PACK16"},
...
static std::map<uint32_t, std::string> ColorSpaces{
...
static std::map<uint32_t, std::string> PresentModes{
...
static std::map<uint32_t, std::string> CompositeAlphaFlags{
    {0x00000001, "VK_COMPOSITE_ALPHA_OPAQUE_BIT_KHR"},
    {0x00000002,
     "VK_COMPOSITE_ALPHA_PRE_MULTIPLIED_BIT_KHR"},
    {0x00000004,
     "VK_COMPOSITE_ALPHA_POST_MULTIPLIED_BIT_KHR"},
    {0x00000008, "VK_COMPOSITE_ALPHA_INHERIT_BIT_KHR"}};

static std::map<uint32_t, std::string> TransformFlags{
    {0x00000001, "VK_SURFACE_TRANSFORM_IDENTITY_BIT_KHR"},
    {0x00000002, "VK_SURFACE_TRANSFORM_ROTATE_90_BIT_KHR"},
    {0x00000004, "VK_SURFACE_TRANSFORM_ROTATE_180_BIT_KHR"},
    {0x00000008, "VK_SURFACE_TRANSFORM_ROTATE_270_BIT_KHR"},
    {0x00000010,
     "VK_SURFACE_TRANSFORM_HORIZONTAL_MIRROR_BIT_KHR"},
    {0x00000020,
     "VK_SURFACE_TRANSFORM_HORIZONTAL_MIRROR_ROTATE_90_BIT_"
     "KHR"},
    {0x00000040,
     "VK_SURFACE_TRANSFORM_HORIZONTAL_MIRROR_ROTATE_180_"
     "BIT_KHR"},
    {0x00000080,
     "VK_SURFACE_TRANSFORM_HORIZONTAL_MIRROR_ROTATE_270_"
     "BIT_KHR"},
    {0x00000100, "VK_SURFACE_TRANSFORM_INHERIT_BIT_KHR"}};
}  // namespace vka